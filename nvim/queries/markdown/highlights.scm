; Local override for Neovim 0.12 + current nvim-treesitter markdown queries.
; The upstream query uses `conceal_lines`, which is currently tripping the
; treesitter decoration provider in this setup.
